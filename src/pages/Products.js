...
const Products = () => {
  ...
  const fetchProductOfTheDay = async () => {
    try {
      ...
      console.error('Error fetching product of the day:', error);
      toast.error('Error fetching product of the day');
    }
  };
  ...
  const updateProductOfTheDayStatus = async (productId, isProductOfTheDay) => {
    try {
      ...
      if (!isProductOfTheDay) {
        ...
        toast.success('Product removed from Product of the Day');
      } else {
        // First, unmark any existing product of the day
        if (productOfTheDay) {
          const currentProductRef = doc(db, 'products', productOfTheDay.id);
        ...
        toast.success('Product set as Product of the Day');
      }
      ...
      console.error('Error updating product of the day:', error);
      toast.error('Error updating product of the day');
    }
  };
         ...
         <div className="best-sellers-section">
           <div className="section-header">
             <h2>
               ...
               Best Sellers ({bestSellers.length}/4)
             </h2>
           </div>
          ...
          <div className="modal-content confirmation-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>
                ...
                Confirm {confirmationType === 'productOfDay' ? 'Product of the Day' : 'Best Seller'}
              </h2>
            ...
            <div className="modal-body">
                 ...
                 <p>⚠️ {confirmationType === 'productOfDay' 
                   ? 'This action will replace the current Product of the Day.' 
                   : `This action will add the product to Best Sellers (${bestSellers.length + 1}/4).`}</p>
               </div>
              ...
              <div className="confirmation-actions">
                <p>Are you sure you want to set this product as the <strong>{confirmationType === 'productOfDay' ? 'Product of the Day' : 'Best Seller'}</strong>?</p>
                <div className="modal-actions">
                  ...
                  <button className="btn btn-primary" onClick={confirmationType === 'productOfDay' ? confirmProductOfTheDay : confirmBestSeller}>
                    ...
                    Set as {confirmationType === 'productOfDay' ? 'Product of the Day' : 'Best Seller'}
                  </button>
                </div>
              </div>
            </div>
